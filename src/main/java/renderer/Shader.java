...
public class Shader {
    ...
    public Shader(String filepath) {
        ...
        try{
            ...
            // Find the first patten after #type 'pattern'
            int index = source.indexOf("#type") + 6;
            int eol = source.indexOf("\r\n", index);
            String firstPattern = source.substring(index, eol).trim();

            // Find the second patten after #type 'pattern'
            index = source.indexOf("#type",eol) + 6;
            eol = source.indexOf("\r\n", index);
            String secondPatten = source.substring(index, eol).trim();
            ...
            if(secondPatten.equals("vertex")){
                vertexSource = splitString[2];
            }else if (secondPatten.equals("fragment")){
                fragmentSource = splitString[2];
            }else {
                throw  new IOException("Unexpected token '"+secondPatten+"'");
            }
